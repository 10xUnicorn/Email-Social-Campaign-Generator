    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex gap-3 flex-wrap">
          ...
          <a href="/content-ingest" className="px-5 py-2.5 rounded-lg font-medium text-sm transition-colors text-white" style={{background: "linear-gradient(135deg, #7c3aed, #db2777)"}}>Repurpose</a>
